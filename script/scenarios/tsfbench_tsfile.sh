...
readonly TSFILE_TABLE_BACKEND_SELECTOR="${TSFILE_TABLE_BACKEND_SELECTOR:-tsfile@candidate+table}"
readonly TSFILE_TREE_BACKEND_SELECTOR="${TSFILE_TREE_BACKEND_SELECTOR:-tsfile@candidate+tree}"

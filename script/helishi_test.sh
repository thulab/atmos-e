...
modify_iotdb_config() { # iotdb调整内存，关闭合并
	...
	#调整测试参数
	sed -i "s/^# data_region_group_extension_policy=.*$/data_region_group_extension_policy=CUSTOM/g" ${TEST_IOTDB_PATH}/conf/iotdb-system.properties
	sed -i "s/^# default_data_region_group_num_per_database=.*$/default_data_region_group_num_per_database=1/g" ${TEST_IOTDB_PATH}/conf/iotdb-system.properties
	sed -i "s/^# datanode_memory_proportion=.*$/datanode_memory_proportion=11:6:1:0:0:2/g" ${TEST_IOTDB_PATH}/conf/iotdb-system.properties
	sed -i "s/^# compaction_write_throughput_mb_per_sec=.*$/compaction_write_throughput_mb_per_sec=4/g" ${TEST_IOTDB_PATH}/conf/iotdb-system.properties
	sed -i "s/^# compaction_read_throughput_mb_per_sec=.*$/compaction_read_throughput_mb_per_sec=10/g" ${TEST_IOTDB_PATH}/conf/iotdb-system.properties
	sed -i "s/^# enable_last_cache=.*$/enable_last_cache=false/g" ${TEST_IOTDB_PATH}/conf/iotdb-system.properties
	#关闭影响写入性能的其他功能
	...
	#sed -i "s/^cn_internal_address.*$/cn_internal_address=${IoTDB_IP}/g" ${TEST_IOTDB_PATH}/conf/iotdb-system.properties
	#sed -i "s/^cn_seed_config_node.*$/cn_seed_config_node=${IoTDB_IP}:10710/g" ${TEST_IOTDB_PATH}/conf/iotdb-system.properties
	#sed -i "s/^dn_rpc_address.*$/dn_rpc_address=${IoTDB_IP}/g" ${TEST_IOTDB_PATH}/conf/iotdb-system.properties
	#sed -i "s/^dn_internal_address.*$/dn_internal_address=${IoTDB_IP}/g" ${TEST_IOTDB_PATH}/conf/iotdb-system.properties
	#sed -i "s/^dn_seed_config_node.*$/dn_seed_config_node=${IoTDB_IP}:10710/g" ${TEST_IOTDB_PATH}/conf/iotdb-system.properties	
}
set_protocol_class() { 
	config_node=$1
	schema_region=$2

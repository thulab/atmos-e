...
BUCKUP_PATH=/nasdata/unse_query
...
PASSWORD="iotdb2019"
DBNAME="QA_ATM"  #数据库名称
TABLENAME="test_result_unse_query" #数据库中表的名称
SERVERTABLE="SERVER_MODE_unse_query"
...
test_operation() {
	...
	do
		...
		do
			...
			mv ${TEST_DATANODE_PATH}/logs ${TEST_DATANODE_PATH}/logs_${query_list[${i}]}
			#停止IoTDB程序和监控程序
			check_monitor_pid
			check_iotdb_pid
			sleep 5

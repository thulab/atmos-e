...
# ------------------------------------------------------------------------------
# Description: 自动化执行 IoTDB UNSE 写入测试，并将结果回写到 MySQL。
# Notes:
...
readonly BACKUP_PATH="/nasdata/repository/unse_insert"
...
readonly TABLENAME="test_result_unse_insert"
readonly TABLENAME_T="test_result_unse_insert"

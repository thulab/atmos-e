#!/usr/bin/env bash
# ------------------------------------------------------------------------------
# IoTDB API Insert Script
# ------------------------------------------------------------------------------
# Description: 自动化执行 IoTDB API 写入测试，并将结果回写到 MySQL。
# Notes:
...
readonly BACKUP_PATH="/nasdata/repository/api_insert"
...
readonly TABLENAME="test_result_api_insert"
readonly TABLENAME_T="test_result_api_insert"
